...
if ($path === '/sitemap.xml') {
    ...
    $urls = ['/', '/es/', '/ca/', '/servicios/', '/es/servicios/', '/ca/serveis/', '/proyectos/', '/es/proyectos/', '/ca/projectes/', '/sobre-nosotros/', '/es/sobre-nosotros/', '/ca/sobre-nosaltres/', '/contacto/', '/es/contacto/', '/ca/contacte/', '/obra-nueva/', '/es/obra-nueva/', '/ca/obra-nova/', '/reformas-integrales/', '/es/reformas-integrales/', '/ca/reformes-integrals/', '/pladur-acabados/', '/es/pladur-acabados/', '/ca/pladur-acabats/', '/obra-publica/', '/es/obra-publica/', '/ca/obra-publica/', '/obra-civil/', '/es/obra-civil/', '/ca/obra-civil/', '/reformas-barcelona/', '/es/reformas-barcelona/', '/reformas-girona/', '/es/reformas-girona/', '/reformas-tarragona/', '/es/reformas-tarragona/', '/obra-nueva-barcelona/', '/es/obra-nueva-barcelona/', '/obra-nueva-girona/', '/es/obra-nueva-girona/', '/obra-nueva-tarragona/', '/es/obra-nueva-tarragona/', '/blog/', '/es/blog/', '/es/blog/cuanto-tarda-reforma-integral/', '/es/blog/obra-nueva-barcelona-guia/', '/es/blog/materiales-reforma-calidad-precio/', '/es/blog/humedades-viviendas-causas-soluciones/', '/es/blog/pago-fraccionado-reformas/', '/es/blog/reformas-edificios-antiguos-barcelona/'];
...
$routes = [
    ...
    'servicios/parquet-pavimentos' => 'parquet-pavimentos.php',
    'servicios/reformas-banos' => 'reformas-banos.php',
    'servicios/rehabilitacion-fachadas' => 'rehabilitacion-fachadas.php',
    'servicios/reformas-comerciales' => 'reformas-comerciales.php',
    ...
    'parquet-pavimentos' => 'parquet-pavimentos.php',
    'reformas-banos' => 'reformas-banos.php',
    'rehabilitacion-fachadas' => 'rehabilitacion-fachadas.php',
    'reformas-comerciales' => 'reformas-comerciales.php',
    ...
    'blog' => 'blog.php',
    'blog/cuanto-cuesta-reformar-piso-barcelona' => 'blog/cuanto-cuesta-reformar-piso-barcelona.php',
    'blog/licencias-reformas-integrales-cataluna' => 'blog/licencias-reformas-integrales-cataluna.php',
    'blog/pladur-cuando-conviene-cuanto-cuesta' => 'blog/pladur-cuando-conviene-cuanto-cuesta.php',
    'blog/errores-encarecen-reforma' => 'blog/errores-encarecen-reforma.php',
    'blog/como-elegir-empresa-reformas-barcelona' => 'blog/como-elegir-empresa-reformas-barcelona.php',
    'blog/reforma-integral-vs-parcial' => 'blog/reforma-integral-vs-parcial.php',
    'blog/cuanto-tarda-reforma-integral' => 'blog/cuanto-tarda-reforma-integral.php',
    'blog/obra-nueva-barcelona-guia' => 'blog/obra-nueva-barcelona-guia.php',
    'blog/materiales-reforma-calidad-precio' => 'blog/materiales-reforma-calidad-precio.php',
    'blog/humedades-viviendas-causas-soluciones' => 'blog/humedades-viviendas-causas-soluciones.php',
    'blog/pago-fraccionado-reformas' => 'blog/pago-fraccionado-reformas.php',
    'blog/reformas-edificios-antiguos-barcelona' => 'blog/reformas-edificios-antiguos-barcelona.php',
...
$ca_routes = [
    ...
    'serveis/parquet-paviments' => 'parquet-pavimentos.php',
    'serveis/reformes-banys' => 'reformas-banos.php',
    'serveis/rehabilitacio-facanes' => 'rehabilitacion-fachadas.php',
    'serveis/reformes-comercials' => 'reformas-comerciales.php',
    'obra-nova' => 'obra-nueva.php',
    'reformes-integrals' => 'reformas-integrales.php',
    'pladur-acabats' => 'pladur-acabados.php',
    'obra-publica' => 'obra-publica.php',
    'obra-civil' => 'obra-civil.php',
    'parquet-paviments' => 'parquet-pavimentos.php',
    'reformes-banys' => 'reformas-banos.php',
    'rehabilitacio-facanes' => 'rehabilitacion-fachadas.php',
    'reformes-comercials' => 'reformas-comerciales.php',
