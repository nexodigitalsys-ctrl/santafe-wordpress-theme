        ...
        <div class="grid lg:grid-cols-2 gap-16">
                ...
                <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" data-ajax="true" novalidate>
                    ...
                    <div class="grid md:grid-cols-2 gap-5 mb-5">
                        ...
                        <div>
                            ...
                            <input type="tel" name="phone" required inputmode="numeric" pattern="[0-9]*" class="w-full bg-white border border-warm-300 rounded-sm px-4 py-3 text-warm-900 focus:border-brand-500 focus:outline-none transition-colors">
                        </div>
                    </div>
                    <div class="mb-5">
            ...
            <aside class="space-y-8">
                ...
                <div>
                    ...
                    <p class="text-warm-500">Barcelona, Girona, Tarragona y cercanías</p>
                </div>
            </aside>
        </div>
    </div>
