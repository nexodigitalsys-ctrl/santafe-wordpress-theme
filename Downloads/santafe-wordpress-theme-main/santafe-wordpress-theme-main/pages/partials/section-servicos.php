...
$services = $lang === 'ca' ? [
    [
        ...
        'img' => '/assets/images/real/obra-nueva-desde-cero.webp',
    ...
    [
        ...
        'cta' => 'Veure reformes →',
        'img' => '/assets/images/real/reforma-completa-casa-barcelona.webp',
        'icon' => $icon_reforma,
    ],
    [
        'slug' => 'pladur-acabats',
        ...
        'cta' => 'Veure acabats →',
        'img' => '/assets/images/real/pladur-instalacion.webp',
        'icon' => $icon_pladur,
    ],
    [
        'slug' => 'obra-publica',
        ...
        'img' => '/assets/images/real/obra-publica-general.webp',
        'icon' => $icon_publica,
    ],
    [
        'slug' => 'obra-civil',
        ...
        'img' => '/assets/images/real/obra-civil-muros.webp',
        'icon' => $icon_civil,
    ],
    [
        'slug' => 'parquet-paviments',
        'title' => 'Parquet i paviments',
        'desc' => 'Instal·lació, renovació i reparació de parquet amb acabat professional.',
        'cta' => 'Veure parquet →',
        'img' => '/assets/images/real/parquet-instalacion.webp',
        'icon' => $icon_reforma,
    ],
    [
        'slug' => 'reformes-banys',
        'title' => 'Reforma de banys',
        'desc' => 'Reforma completa de banys amb impermeabilització i garantia d\'estanqueïtat.',
        'cta' => 'Veure banys →',
        'img' => '/assets/images/real/reforma-banos-lavabos.webp',
        'icon' => $icon_reforma,
    ],
    [
        'slug' => 'rehabilitacio-facanes',
        'title' => 'Rehabilitació de façanes',
        'desc' => 'Reparació d\'esquerdes, humitats i aïllament tèrmic exterior.',
        'cta' => 'Veure façanes →',
        'img' => '/assets/images/real/rehabilitacion-casa.webp',
        'icon' => $icon_obra_nueva,
    ],
    [
        'slug' => 'reformes-comercials',
        'title' => 'Reformes comercials',
        'desc' => 'Reformes de botigues i locals amb llicència inclosa.',
        'cta' => 'Veure comercials →',
        'img' => '/assets/images/real/reforma-comercial-tienda.webp',
        'icon' => $icon_publica,
    ],
] : [
    [
    ...
    [
        ...
        'title' => 'Parquet y pavimentos',
        'desc' => 'Instalación, renovación y reparación de parquet con acabado profesional.',
        'cta' => 'Ver parquet →',
        'img' => '/assets/images/real/parquet-instalacion.webp',
        'icon' => $icon_reforma,
    ],
    [
        ...
        'desc' => 'Reforma completa de baños con impermeabilización y garantía.',
        'cta' => 'Ver baños →',
        'img' => '/assets/images/real/reforma-banos-lavabos.webp',
        'icon' => $icon_reforma,
    ],
    [
        ...
        'desc' => 'Reparación de grietas, humedades y aislamiento térmico exterior.',
        'cta' => 'Ver fachadas →',
        'img' => '/assets/images/real/rehabilitacion-casa.webp',
        'icon' => $icon_obra_nueva,
    ],
    [
        ...
        'desc' => 'Reformas de tiendas y locales con licencia incluida.',
        'cta' => 'Ver comerciales →',
        'img' => '/assets/images/real/reforma-comercial-tienda.webp',
        'icon' => $icon_publica,
    ],
...
<section data-reveal class="py-24 md:py-32 section-servicios" id="servicios">
        ...
        <div class="flex flex-col md:flex-row md:items-end md:justify-between mb-16 gap-6">
            <div>
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <span class="section-servicios-badge text-xs font-semibold uppercase tracking-[0.3em]"><?php echo t($translations, 'nav.services'); ?></span>
                </div>
                <h2 class="font-display font-bold text-4xl md:text-5xl lg:text-6xl section-servicios-title tracking-tight"><?php echo $title; ?></h2>
            </div>
        </div>

        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6" id="servicios-grid">
            <?php foreach ($services as $svc): ?>
            <article class="service-card tilt-card group relative overflow-hidden rounded-sm section-servicios-card border shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all duration-300 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-brand-900/20">
                <div class="aspect-[16/10] overflow-hidden section-sobre-image relative">
                    ...
                    <div class="absolute top-4 left-4 w-12 h-12 section-servicios-card-icon backdrop-blur-sm rounded-lg flex items-center justify-center shadow-lg">
                        <?php echo $svc['icon']; ?>
                    </div>
                </div>
                <div class="p-6">
                    <h3 class="font-display font-bold text-xl section-servicios-title mb-2"><?php echo $svc['title']; ?></h3>
                    <p class="section-servicios-body text-sm leading-relaxed mb-4"><?php echo $svc['desc']; ?></p>
                    <a href="/<?php echo $lang; ?>/<?php echo $svc['slug']; ?>/" class="inline-flex items-center gap-2 section-servicios-link text-sm font-semibold group/link transition-colors">
                        <?php echo $svc['cta']; ?>
