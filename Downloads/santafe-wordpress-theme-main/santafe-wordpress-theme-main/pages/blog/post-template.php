            ...
            <div class="flex flex-wrap gap-4">
                <a href="https://wa.me/<?php echo WHATSAPP_NUMBER; ?>?text=Hola%20Paulo%2C%20he%20leído%20tu%20artículo%20sobre%20<?php echo urlencode($post_title); ?>"
                   target="_blank" rel="noopener noreferrer"
                    class="inline-flex items-center gap-2 bg-[#25d366] hover:bg-[#128c7e] text-white font-medium px-4 py-2 rounded-xl transition-all text-xs uppercase tracking-wide">
                ...
                <a href="/<?php echo $lang; ?>/contacto/"
                    class="inline-flex items-center gap-2 bg-brand-600 hover:bg-brand-500 text-white font-medium px-4 py-2 rounded-xl transition-all text-xs uppercase tracking-wide">
