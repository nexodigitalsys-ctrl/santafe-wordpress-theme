            ...
            <div class="flex flex-wrap gap-6">
                <a href="https://wa.me/<?php echo WHATSAPP_NUMBER; ?>?text=Hola%20Paulo%2C%20estoy%20interesado%20en%20un%20proyecto"
                   target="_blank" rel="noopener noreferrer"
                    class="inline-flex items-center gap-2 bg-[#25d366] hover:bg-[#128c7e] text-white font-medium px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl transition-all text-xs uppercase tracking-wide">
                ...
                <a href="/<?php echo $lang; ?>/contacto/"
                    class="inline-flex items-center gap-2 bg-brand-600 hover:bg-brand-500 text-white font-medium px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl transition-all text-xs uppercase tracking-wide">
                    <?php echo $t['hero_cta_budget']; ?>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                </a>
                <a href="tel:<?php echo COMPANY_PHONE; ?>"
                    class="inline-flex items-center gap-2 border border-warm-300 hover:border-slate-400 text-warm-600 hover:text-white font-medium px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl transition-all text-xs uppercase tracking-wide">
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <article class="mb-16 last:mb-0">
            <div class="grid lg:grid-cols-2 gap-8 items-start">
                <!-- Imagem -->
                <div class="relative rounded-sm overflow-hidden bg-warm-100 aspect-[4/3]">
                ...
                <div class="flex flex-col h-full">
                    ...
                    <div class="mt-6 pt-6 border-t border-warm-200">
                        ...
                        <div class="flex flex-wrap gap-3">
                            ...
                            <span class="text-sm bg-warm-100 text-warm-600 px-3 py-1.5 rounded-sm"><?php echo $spec; ?></span>
                            <?php endforeach; ?>
                        </div>
                    </div>
