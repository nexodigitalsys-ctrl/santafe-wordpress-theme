...
<style>
  ...
  html.dark section .text-xs:not(a):not(button),
  ...
  /* Buttons in dark mode — force white text on spans inside button-like a/button */
  html.dark section a.rounded-xl.text-xs span,
  html.dark section button.rounded-xl.text-xs span { color: #ffffff !important; }
...
<a href="https://wa.me/<?php echo WHATSAPP_NUMBER; ?>?text=Hola%20Paulo%2C%20estoy%20interesado%20en%20una%20reforma" 
   class="fixed bottom-6 right-6 z-50 w-11 h-11 bg-[#25d366] hover:bg-[#128c7e] text-white rounded-full flex items-center justify-center shadow-lg transition-all hover:scale-110" 
