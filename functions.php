...
function santafe_send_contact_email(array $data, array $attachments = []): bool {
    ...
    $body = '<html><body style="font-family: Arial, sans-serif; background: #f5f5f5; padding: 20px;">'
        ...
        . '<a href="https://www.santafe-construcciones.com" target="_blank" style="text-decoration: none;">'
        . '<img src="' . esc_url(get_template_directory_uri() . '/assets/img/construcciones-santa-fe-girona.png') . '" alt="Santa Fe Construcciones" style="max-width: 260px; width: 100%; height: auto; border-radius: 6px;">'
        . '</a>'
        . '</div>'
