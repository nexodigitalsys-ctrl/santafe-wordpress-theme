...
function santafe_get_seo_data(string $route = '', string $lang = 'es'): array {
    ...
    $es = [
        '' => ['Santa Fe Construcciones | Reformas y obra nueva en Barcelona, Girona y Tarragona', 'Empresa de construcción con 17 años de experiencia. Reformas integrales, obra nueva, pladur, obra pública y obra civil. Presupuesto cerrado en 24/48h, sin sorpresas.'],
        'contacto' => ['Contacto | Santa Fe Construcciones - Presupuesto en 24/48h', 'Solicita presupuesto gratuito para reforma, obra nueva o pladur en Barcelona, Girona o Tarragona. Respuesta en menos de 2 horas.'],
        ...
        'reformas-integrales' => ['Reformas integrales Barcelona | Presupuesto cerrado en 24/48h', 'Reforma integral de pisos y locales en Barcelona, Girona y Tarragona. Presupuesto detallado por partidas, plazo garantizado y seguimiento semanal con fotos.'],
