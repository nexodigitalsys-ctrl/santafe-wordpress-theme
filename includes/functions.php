...
function get_og_image(string $route = '', string $lang = 'es'): string {
    ...
    $map = [
        ...
        'parquet-pavimentos' => '/assets/images/og-parquet-pavimentos.jpg',
        'parquet-paviments' => '/assets/images/og-parquet-pavimentos.jpg',
        'reformas-banos' => '/assets/images/og-reformas-banos.jpg',
        'reformes-banys' => '/assets/images/og-reformas-banos.jpg',
        'rehabilitacion-fachadas' => '/assets/images/og-rehabilitacion-fachadas.jpg',
        'rehabilitacio-facanes' => '/assets/images/og-rehabilitacion-fachadas.jpg',
        'reformas-comerciales' => '/assets/images/og-reformas-comerciales.jpg',
        'reformes-comercials' => '/assets/images/og-reformas-comerciales.jpg',
