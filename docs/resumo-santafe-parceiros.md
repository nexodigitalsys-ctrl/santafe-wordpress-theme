...
7. **Testimonios** — 6 reviews reais de Google (5★)
   - Importadas diretamente do perfil Google
   - Google badge: 5.0★ / 6 opiniones verificadas
...
- Schema JSON-LD: LocalBusiness + AggregateRating 5.0/6 + 6 Reviews + FAQPage + BreadcrumbList
