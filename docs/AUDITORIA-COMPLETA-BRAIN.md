...
|-----|-----------|---------|
| AggregateRating: 127 reviews vs 6 embedados | 🔴 Crítico | Google pode penalizar schema enganoso |
...
| 4 | **Corrigir schema review (127 → 6 reviews reais 5.0)** | Evitar penalização Google | Baixo |
...
4. ✅ Corrigir schema review (127 → 6 reviews reais 5.0)
