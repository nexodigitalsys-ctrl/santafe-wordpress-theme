...
<section class="py-24 md:py-32 section-reviews border-y" data-reveal>
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="text-center mt-10">
            <a href="https://g.co/kgs/8t9vHjZ" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 section-reviews-link transition-colors text-sm font-medium">
                <?php echo $t['cta']; ?>
