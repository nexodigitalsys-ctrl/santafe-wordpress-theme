...
<section class="py-24 md:py-32 bg-warm-50 border-y border-warm-200" data-reveal>
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="text-center mb-16">
            ...
            <h2 class="font-display font-bold text-3xl md:text-4xl text-warm-900 tracking-tight mb-8"><?php echo $t['title']; ?></h2>
            ...
            <a href="https://g.co/kgs/8t9vHjZ" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-4 bg-white rounded-lg px-6 py-4 shadow-lg hover:shadow-xl transition-all group">
                ...
                <div class="text-left">
                    <div class="flex items-center gap-2">
                        <span class="text-warm-900 font-bold text-2xl">4.9</span>
                        <div class="flex"><?php echo render_stars_small(5); ?></div>
                    </div>
                    <p class="text-warm-500 text-sm"><?php echo $t['badge']; ?></p>
                </div>
        ...
        <div class="google-reviews-grid">
            ...
            <div class="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        <p class="text-warm-900 font-semibold text-sm"><?php echo htmlspecialchars($r['author']); ?></p>
                        <div class="flex"><?php echo render_stars_small($r['rating']); ?></div>
                    </div>
                </div>
                <p class="text-warm-500 text-sm leading-relaxed">&ldquo;<?php echo htmlspecialchars($r['text']); ?>&rdquo;</p>
                <div class="flex items-center gap-1.5 mt-3">
                    ...
                    <span class="text-warm-500 text-xs"><?php echo $isCa ? 'Verificada' : 'Verificada'; ?></span>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
