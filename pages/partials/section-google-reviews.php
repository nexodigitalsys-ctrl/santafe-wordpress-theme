...
<section class="py-24 md:py-32 section-reviews border-y" data-reveal>
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="text-center mb-16">
            ...
            <a href="https://maps.app.goo.gl/QTBgkprQeRCaQ3UUA" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-4 bg-white rounded-lg px-6 py-4 shadow-lg hover:shadow-xl transition-all group">
        ...
        <div class="text-center mt-10">
            <a href="https://maps.app.goo.gl/QTBgkprQeRCaQ3UUA" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 section-reviews-link transition-colors text-sm font-medium">
                <?php echo $t['cta']; ?>
