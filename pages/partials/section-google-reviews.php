...
<section class="py-24 md:py-32 bg-slate-900 border-y border-slate-800" data-reveal>
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="text-center mb-16">
            ...
            <h2 class="font-display font-bold text-3xl md:text-4xl text-white tracking-tight mb-8"><?php echo $t['title']; ?></h2>
            ...
            <a href="https://g.co/kgs/8t9vHjZ" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-4 bg-white rounded-lg px-6 py-4 shadow-lg hover:shadow-xl transition-all group">
                ...
                <div class="text-left">
                    <div class="flex items-center gap-2">
                        <span class="text-slate-900 font-bold text-2xl">4.9</span>
                        <div class="flex"><?php echo render_stars_small(5); ?></div>
                    </div>
                    <p class="text-slate-500 text-sm"><?php echo $t['badge']; ?></p>
                </div>
                <svg class="w-5 h-5 text-slate-400 group-hover:text-blue-500 transition-colors ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
            </a>
        </div>
        ...
        <div class="google-reviews-grid">
            ...
            <div class="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        <p class="text-slate-900 font-semibold text-sm"><?php echo htmlspecialchars($r['author']); ?></p>
                        <div class="flex"><?php echo render_stars_small($r['rating']); ?></div>
                    </div>
                </div>
                <p class="text-slate-600 text-sm leading-relaxed">&ldquo;<?php echo htmlspecialchars($r['text']); ?>&rdquo;</p>
                <div class="flex items-center gap-1.5 mt-3">
                    ...
                    <span class="text-slate-400 text-xs"><?php echo $isCa ? 'Verificada' : 'Verificada'; ?></span>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
