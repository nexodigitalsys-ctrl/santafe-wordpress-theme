...
<section data-reveal class="py-24 md:py-32 bg-white relative overflow-hidden" id="contacto">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        <div class="text-center mb-16">
            ...
            <h2 class="font-display font-bold text-4xl md:text-5xl lg:text-6xl text-gray-900 tracking-tight mb-6"><?php echo $title; ?></h2>
        ...
        <div class="grid lg:grid-cols-[1fr_0.9fr] gap-16">
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-sm p-8 md:p-10">
                <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" data-ajax="true" novalidate>
                    ...
                    <div class="mb-5">
                        <label class="block text-gray-500 text-xs uppercase tracking-wider mb-2"><?php echo $lang === 'ca' ? 'Fotos del projecte (opcional)' : 'Fotos del proyecto (opcional)'; ?></label>
                        <input type="file" name="project_photos[]" accept="image/*,.pdf" multiple class="w-full bg-white border border-gray-300 rounded-sm px-4 py-3 text-gray-600 focus:border-brand-500 focus:outline-none transition-colors file:mr-4 file:py-2 file:px-4 file:rounded-sm file:border-0 file:text-sm file:font-semibold file:bg-brand-600 file:text-white hover:file:bg-brand-500">
                        <p class="text-gray-500 text-xs mt-2"><?php echo $lang === 'ca' ? 'Màx. 5 arxius (JPG, PNG, PDF)' : 'Máx. 5 archivos (JPG, PNG, PDF)'; ?></p>
                    </div>
                    <div class="mb-6">
            ...
            <aside class="space-y-8">
                <div>
                    ...
                    <div class="space-y-5">
                        <a href="tel:<?php echo COMPANY_PHONE; ?>" class="flex items-center gap-4 group">
                            ...
                            <div>
                                <p class="text-gray-500 text-xs uppercase tracking-wider"><?php echo $alt_phone; ?></p>
                        ...
                        <a href="https://wa.me/<?php echo WHATSAPP_NUMBER; ?>" target="_blank" rel="noopener noreferrer" class="flex items-center gap-4 group">
                            ...
                            <div>
                                <p class="text-gray-500 text-xs uppercase tracking-wider"><?php echo $alt_whatsapp; ?></p>
                                <p class="text-gray-900 font-semibold text-lg"><?php echo COMPANY_PHONE_DISPLAY; ?></p>
                            </div>
                        </a>
                ...
                <div class="bg-brand-950/20 border border-brand-900/30 rounded-sm p-5">
                    ...
                    <p class="text-gray-500 text-sm"><?php echo $lang === 'ca' ? 'Pagament fraccionat vinculat a fites de l\'obra. Consulta\'ns les opcions.' : 'Pago fraccionado vinculado a hitos de la obra. Consúltanos las opciones.'; ?></p>
                </div>
