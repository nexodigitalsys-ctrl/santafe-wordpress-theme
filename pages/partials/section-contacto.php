...
<section data-reveal class="py-24 md:py-32 bg-white relative overflow-hidden" id="contacto">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        <div class="text-center mb-16">
            ...
            <h2 class="font-display font-bold text-4xl md:text-5xl lg:text-6xl text-warm-900 tracking-tight mb-6"><?php echo $title; ?></h2>
            <p class="text-warm-600 text-lg leading-relaxed mb-10 max-w-2xl mx-auto"><?php echo $subtitle; ?></p>
        </div>

        <div class="grid lg:grid-cols-[1fr_0.9fr] gap-16">
            <!-- Form -->
            <div class="bg-warm-50 border border-warm-200 rounded-xl shadow-card p-8 md:p-10">
                <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" data-ajax="true" novalidate>
                    ...
                    <div class="grid md:grid-cols-2 gap-5 mb-5">
                        <div>
                            ...
                            <input type="text" name="name" required class="w-full bg-white border border-warm-300 rounded-lg px-4 py-3 text-warm-900 focus:border-brand-500 focus:outline-none transition-colors">
                        </div>
                        <div>
                            <label class="block text-warm-500 text-xs uppercase tracking-wider mb-2"><?php echo $label_telefono; ?> *</label>
                            <input type="tel" name="phone" required class="w-full bg-white border border-warm-300 rounded-lg px-4 py-3 text-warm-900 focus:border-brand-500 focus:outline-none transition-colors">
                        </div>
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="grid md:grid-cols-2 gap-5 mb-5">
                        <div>
                            ...
                            <select name="service_interest" required class="w-full bg-white border border-warm-300 rounded-lg px-4 py-3 text-warm-600 focus:border-brand-500 focus:outline-none transition-colors">
                        ...
                        <div>
                            ...
                            <select name="city" required class="w-full bg-white border border-warm-300 rounded-lg px-4 py-3 text-warm-600 focus:border-brand-500 focus:outline-none transition-colors">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea name="message" rows="4" required placeholder="<?php echo $placeholder_mensaje; ?>" class="w-full bg-white border border-warm-300 rounded-lg px-4 py-3 text-warm-900 focus:border-brand-500 focus:outline-none transition-colors resize-y"></textarea>
                    </div>
                    <div class="mb-5">
                        <label class="block text-warm-500 text-xs uppercase tracking-wider mb-2"><?php echo $lang === 'ca' ? 'Fotos del projecte (opcional)' : 'Fotos del proyecto (opcional)'; ?></label>
                        <input type="file" name="project_photos[]" accept="image/*,.pdf" multiple class="w-full bg-white border border-warm-300 rounded-lg px-4 py-3 text-warm-600 focus:border-brand-500 focus:outline-none transition-colors file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-brand-600 file:text-white hover:file:bg-brand-700">
                    ...
                    <button type="submit" class="w-full bg-brand-600 hover:bg-brand-700 text-white font-semibold py-4 rounded-xl transition-all duration-300 tracking-wide uppercase text-sm relative overflow-hidden group shadow-lg shadow-brand-600/20">
            ...
            <aside class="space-y-8">
                <div>
                    ...
                    <div class="space-y-5">
                        <a href="tel:<?php echo COMPANY_PHONE; ?>" class="flex items-center gap-4 group">
                            <div class="w-12 h-12 bg-warm-100 rounded-xl flex items-center justify-center group-hover:bg-brand-100 transition-colors duration-300">
                            ...
                            <div>
                                <p class="text-warm-500 text-xs uppercase tracking-wider"><?php echo $alt_phone; ?></p>
                        ...
                        <a href="https://wa.me/<?php echo WHATSAPP_NUMBER; ?>" target="_blank" rel="noopener noreferrer" class="flex items-center gap-4 group">
                            ...
                            <div>
                                <p class="text-warm-500 text-xs uppercase tracking-wider"><?php echo $alt_whatsapp; ?></p>
                                <p class="text-warm-900 font-semibold text-lg"><?php echo COMPANY_PHONE_DISPLAY; ?></p>
                            </div>
                        </a>
                ...
                <div class="bg-gradient-to-br from-brand-600 to-brand-700 rounded-xl shadow-card p-5">
                    ...
                    <p class="text-warm-500 text-sm"><?php echo $lang === 'ca' ? 'Pagament fraccionat vinculat a fites de l\'obra. Consulta\'ns les opcions.' : 'Pago fraccionado vinculado a hitos de la obra. Consúltanos las opciones.'; ?></p>
                </div>
                <div class="rounded-xl overflow-hidden border border-warm-200 shadow-card">
                    <iframe
