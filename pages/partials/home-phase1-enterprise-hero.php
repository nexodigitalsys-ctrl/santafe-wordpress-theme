 ...
 * Uses confirmed-safe copy and placeholders where business data still needs owner validation.
 */
...
$audiences = $lang === 'ca'
    ? [
        ...
        ['title' => 'Empreses', 'copy' => 'Coordinacio de gremis, acabats i terminis per a locals, oficines i actius en funcionament.'],
        ['title' => 'Obra publica', 'copy' => 'Execucio ordenada, documentacio i compliment per a projectes amb tracabilitat.'],
    ]
    : [
        ['title' => 'Particulares', 'copy' => 'Reformas y obra nueva con alcance claro, fases visibles y decisiones documentadas.'],
        ['title' => 'Empresas', 'copy' => 'Coordinacion de gremios, acabados y plazos para locales, oficinas y activos en funcionamiento.'],
        ['title' => 'Obra publica', 'copy' => 'Ejecucion ordenada, documentacion y cumplimiento para proyectos con trazabilidad.'],
    ];

$risks = $lang === 'ca'
    ? ['Sobrecostos no previstos', 'Retards sense responsable', 'Gremis descoordinats', 'Llicencies mal plantejades', 'Acabats sense criteri', 'Comunicacio opaca']
    : ['Sobrecostes no previstos', 'Retrasos sin responsable', 'Gremios descoordinados', 'Licencias mal planteadas', 'Acabados sin criterio', 'Comunicacion opaca'];
?>
            ...
            <div class="max-w-4xl">
                <div class="flex items-center gap-4 mb-8 animate-fade-in">
                    ...
                    <span class="text-brand-400 text-xs font-semibold uppercase tracking-[0.3em]">
                        <?php echo $lang === 'ca' ? 'Construccions Santa Fe - Barcelona i Girona' : 'Construcciones Santa Fe - Barcelona y Girona'; ?>
                    </span>
                </div>
                ...
                <p class="text-slate-300 text-lg md:text-xl max-w-2xl mb-10 leading-relaxed animate-slide-up delay-200">
                    <?php echo $lang === 'ca' ? 'Obra nova, reformes integrals, pladur, obra civil i obra publica amb criteri tecnic, pressupost clar i seguiment real d obra.' : 'Obra nueva, reformas integrales, pladur, obra civil y obra publica con criterio tecnico, presupuesto claro y seguimiento real de obra.'; ?>
                </p>
                ...
                <div class="flex flex-wrap gap-4 animate-slide-up delay-300">
                    <a href="/<?php echo $lang; ?>/contacto/" class="inline-flex items-center gap-2 bg-brand-600 hover:bg-brand-500 text-white font-semibold px-8 py-4 rounded-sm transition-all tracking-wide text-sm uppercase">
                        <?php echo $lang === 'ca' ? 'Sollicitar visita tecnica' : 'Solicitar visita tecnica'; ?>
                    ...
                    <a href="/<?php echo $lang; ?>/proyectos/" class="inline-flex items-center gap-2 border border-slate-600 hover:border-slate-400 text-slate-200 font-medium px-8 py-4 rounded-sm transition-all tracking-wide text-sm uppercase">
                        <?php echo $lang === 'ca' ? 'Veure obres i casos' : 'Ver obras y casos'; ?>
                    </a>
                </div>
            </div>
...
<section class="border-y border-slate-800 bg-slate-900/70">
    <div class="max-w-7xl mx-auto px-6 py-8 grid md:grid-cols-4 gap-4">
        <div class="border-l border-brand-700/70 pl-4">
            ...
            <p class="text-slate-500 text-xs uppercase tracking-wider mt-1"><?php echo $lang === 'ca' ? 'Trajectoria pendent de confirmacio final' : 'Trayectoria pendiente de confirmacion final'; ?></p>
        </div>
        <div class="border-l border-slate-700 pl-4">
            <p class="font-display font-bold text-2xl text-white">BCN / Girona</p>
            <p class="text-slate-500 text-xs uppercase tracking-wider mt-1"><?php echo $lang === 'ca' ? 'Zones de servei a validar' : 'Zonas de servicio a validar'; ?></p>
        </div>
        <div class="border-l border-slate-700 pl-4">
        ...
        <div class="border-l border-slate-700 pl-4">
            ...
            <p class="text-slate-500 text-xs uppercase tracking-wider mt-1"><?php echo $lang === 'ca' ? 'Sense desapareixer despres del pressupost' : 'Sin desaparecer despues del presupuesto'; ?></p>
        </div>
    </div>
</section>
