...
<section data-reveal class="py-24 md:py-32 section-sobre border-b" id="sobre-nosotros">
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <!-- Foto TOP: piscina con jardín acabada -->
            <div class="relative order-2 lg:order-1">
                <div class="aspect-[4/5] rounded-sm overflow-hidden section-sobre-image">
                ...
                <div class="absolute -bottom-6 -right-6 section-sobre-float px-6 py-4 rounded-xl shadow-elevated">
            ...
            <div class="order-1 lg:order-2">
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <span class="section-sobre-badge text-xs font-semibold uppercase tracking-[0.3em]"><?php echo t($translations, 'nav.about'); ?></span>
                </div>
                <h2 class="font-display font-bold text-4xl md:text-5xl section-sobre-title tracking-tight mb-2"><?php echo $title; ?></h2>
                <h3 class="font-display font-semibold text-xl section-sobre-subtitle mb-6"><?php echo $subtitle; ?></h3>

                <?php foreach (explode("\n\n", $bio) as $paragraph): ?>
                <p class="section-sobre-body text-lg leading-relaxed mb-5"><?php echo nl2br(htmlspecialchars($paragraph)); ?></p>
                <?php endforeach; ?>

                <!-- Stats -->
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8 mt-8">
                    <?php foreach ($stats as $stat): ?>
                    <div class="border-l-2 section-sobre-stat pl-4 py-2">
                        <p class="font-display font-bold text-2xl md:text-3xl section-sobre-stat-value"><?php echo $stat['number']; ?></p>
                        <p class="section-sobre-stat-label text-sm"><?php echo $stat['label']; ?></p>
                    </div>
                    <?php endforeach; ?>
                </div>
                ...
                <!-- Valores -->
                <div class="mb-8">
                    <h4 class="section-sobre-title font-semibold mb-4 text-sm uppercase tracking-wider"><?php echo $values_title; ?></h4>
                    <div class="grid grid-cols-2 gap-3">
                        <?php foreach ($values as $value): ?>
                        <div class="flex items-start gap-3">
                            <div class="w-2 h-2 rounded-full section-sobre-value-dot mt-2 shrink-0"></div>
                            <div>
                                <p class="section-sobre-value-name font-medium text-sm"><?php echo $value['name']; ?></p>
                                <p class="section-sobre-value-desc text-xs"><?php echo $value['desc']; ?></p>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    </div>
                ...
                <a href="/<?php echo $lang; ?>/sobre-nosotros/" class="inline-flex items-center gap-3 section-sobre-cta font-semibold transition-colors">
