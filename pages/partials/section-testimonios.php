...
?>
<section class="py-24 md:py-32 bg-white relative overflow-hidden" id="testimonios" data-reveal>
    <div class="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-px bg-amber-500/40"></div>
    <div class="max-w-5xl mx-auto px-6 relative z-10">
        <!-- Header -->
        <div class="text-center mb-16">
            <span class="inline-block px-3 py-1 bg-amber-500/10 text-gold-500 text-xs font-bold tracking-widest uppercase rounded-full border border-amber-500/20 mb-4"><?php echo $t['section_subtitle']; ?></span>
            <h2 class="text-3xl md:text-5xl font-extrabold text-warm-900 mb-6 tracking-tight"><?php echo $t['section_title']; ?></h2>
        ...
        <div class="embla relative" id="testimonios-embla">
            <div class="embla__viewport overflow-hidden rounded-2xl border border-warm-200 bg-white/80 backdrop-blur-md shadow-card">
                <div class="embla__container flex">
                    ...
                    <div class="embla__slide min-w-0 px-6 md:px-12 py-12 md:py-16" style="flex: 0 0 100%;">
                        <div class="max-w-3xl mx-auto text-center">
                            ...
                            <blockquote class="text-xl md:text-2xl lg:text-3xl text-warm-900 font-light leading-relaxed mb-10">&ldquo;<?php echo htmlspecialchars($r['text'], ENT_QUOTES, 'UTF-8'); ?>&rdquo;</blockquote>
                            <div class="flex items-center justify-center gap-4">
                                ...
                                <div class="text-left">
                                    <p class="text-warm-900 font-semibold"><?php echo htmlspecialchars($r['author'], ENT_QUOTES, 'UTF-8'); ?></p>
                                    <p class="text-warm-500 text-sm"><?php echo htmlspecialchars($r['type'], ENT_QUOTES, 'UTF-8'); ?> &middot; <?php echo htmlspecialchars($r['city'], ENT_QUOTES, 'UTF-8'); ?></p>
                                </div>
                            </div>
                            <?php if ($r['rating'] === 4): ?>
                            <div class="mt-4 inline-flex items-center gap-1.5 px-3 py-1 bg-gold-50 border border-gold-200 rounded-full">
                                <svg class="w-3 h-3 text-gold-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
                                <span class="text-gold-500 text-xs"><?php echo $t['imperfection']; ?></span>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div class="embla__dots flex justify-center gap-2 mt-8">
                ...
                <button type="button" class="embla__dot w-2 h-2 rounded-full transition-all duration-300 <?php echo $i === 0 ? 'bg-brand-500 w-6' : 'bg-warm-200 hover:bg-gray-400'; ?>" data-index="<?php echo $i; ?>"></button>
                <?php endforeach; ?>
            </div>
        </div>
        ...
        <div class="text-center mt-12">
            <a href="https://g.co/kgs/8t9vHjZ" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 text-warm-500 hover:text-gold-500 transition-colors text-sm font-medium">
                <?php echo $t['view_cta']; ?>
