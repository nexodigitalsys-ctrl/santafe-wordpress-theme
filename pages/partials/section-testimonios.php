...
<section class="py-24 md:py-32 bg-white relative overflow-hidden" id="testimonios" data-reveal>
    ...
    <div class="max-w-5xl mx-auto px-6 relative z-10">
        ...
        <div class="text-center mb-16">
            ...
            <h2 class="text-3xl md:text-5xl font-extrabold text-gray-900 mb-6 tracking-tight"><?php echo $t['section_title']; ?></h2>
            <a href="https://g.co/kgs/8t9vHjZ" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-3 bg-gray-50 border border-gray-300 rounded-full px-5 py-2.5 hover:border-amber-500/40 transition-colors group">
                ...
                <span class="text-gray-900 font-bold text-lg">4.9</span>
                <div class="flex"><?php echo render_stars(5); ?></div>
                <span class="text-gray-500 text-sm"><?php echo $t['badge_text']; ?></span>
                <svg class="w-4 h-4 text-gray-500 group-hover:text-brand-600 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
            </a>
        </div>
        ...
        <div class="embla relative" id="testimonios-embla">
            <div class="embla__viewport overflow-hidden rounded-2xl border border-gray-200 bg-gray-50/50 backdrop-blur-sm">
                <div class="embla__container flex">
                    ...
                    <div class="embla__slide min-w-0 px-6 md:px-12 py-12 md:py-16" style="flex: 0 0 100%;">
                        <div class="max-w-3xl mx-auto text-center">
                            ...
                            <blockquote class="text-xl md:text-2xl lg:text-3xl text-gray-900 font-light leading-relaxed mb-10">&ldquo;<?php echo htmlspecialchars($r['text'], ENT_QUOTES, 'UTF-8'); ?>&rdquo;</blockquote>
                            <div class="flex items-center justify-center gap-4">
                                ...
                                <div class="text-left">
                                    <p class="text-gray-900 font-semibold"><?php echo htmlspecialchars($r['author'], ENT_QUOTES, 'UTF-8'); ?></p>
                                    <p class="text-gray-500 text-sm"><?php echo htmlspecialchars($r['type'], ENT_QUOTES, 'UTF-8'); ?> &middot; <?php echo htmlspecialchars($r['city'], ENT_QUOTES, 'UTF-8'); ?></p>
                                </div>
                            </div>
                            <?php if ($r['rating'] === 4): ?>
            ...
            <div class="embla__dots flex justify-center gap-2 mt-8">
                ...
                <button type="button" class="embla__dot w-2 h-2 rounded-full transition-all duration-300 <?php echo $i === 0 ? 'bg-brand-500 w-6' : 'bg-gray-200 hover:bg-gray-400'; ?>" data-index="<?php echo $i; ?>"></button>
                <?php endforeach; ?>
            </div>
        </div>
        ...
        <div class="text-center mt-12">
            <a href="https://g.co/kgs/8t9vHjZ" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 text-gray-500 hover:text-amber-400 transition-colors text-sm font-medium">
                <?php echo $t['view_cta']; ?>
