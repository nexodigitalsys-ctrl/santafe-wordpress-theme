...
<section data-reveal class="py-24 bg-white border-b border-gray-200" id="calculadora">
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid lg:grid-cols-[0.8fr_1.2fr] gap-12 items-start">
            <div>
                ...
                <h2 class="font-display font-bold text-4xl md:text-5xl text-gray-900 tracking-tight mb-5"><?php echo $title; ?></h2>
                <p class="text-gray-500 leading-relaxed"><?php echo $subtitle; ?></p>
            </div>

            <div class="bg-gray-50 border border-gray-200 rounded-sm p-6 md:p-8" data-budget-calculator>
                <form id="form-calculadora" method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                    ...
                    <div class="grid md:grid-cols-2 gap-5">
                        <label class="block">
                            <span class="block text-gray-500 text-xs uppercase tracking-wider mb-2"><?php echo $label_tipo; ?></span>
                            <select name="tipo_obra" data-calc-service class="w-full bg-white border border-gray-300 rounded-sm px-4 py-3 text-gray-700 focus:border-brand-500 focus:outline-none">
                        ...
                        <label class="block">
                            <span class="block text-gray-500 text-xs uppercase tracking-wider mb-2"><?php echo $label_m2; ?></span>
                            <input type="number" name="metros" data-calc-m2 min="10" max="5000" value="80" class="w-full bg-white border border-gray-300 rounded-sm px-4 py-3 text-gray-900 focus:border-brand-500 focus:outline-none">
                        </label>
                        <label class="block">
                            <span class="block text-gray-500 text-xs uppercase tracking-wider mb-2"><?php echo $label_ciudad; ?></span>
                            <select name="ciudad" data-calc-city class="w-full bg-white border border-gray-300 rounded-sm px-4 py-3 text-gray-700 focus:border-brand-500 focus:outline-none">
                        ...
                        <label class="block">
                            <span class="block text-gray-500 text-xs uppercase tracking-wider mb-2"><?php echo $label_acabado; ?></span>
                            <select name="acabado" data-calc-finish class="w-full bg-white border border-gray-300 rounded-sm px-4 py-3 text-gray-700 focus:border-brand-500 focus:outline-none">
                    ...
                    <div class="mt-6 bg-white border border-gray-200 rounded-sm p-6">
                        <p class="text-gray-500 text-xs uppercase tracking-wider mb-2"><?php echo $result_label; ?></p>
                        <p class="font-display font-bold text-3xl text-gray-900" data-calc-result>—</p>
                        <p class="text-gray-500 text-sm mt-3"><?php echo $disclaimer; ?></p>
                    ...
                    <div class="flex flex-wrap gap-4 mt-6">
                        ...
                        <a href="https://wa.me/<?php echo WHATSAPP_NUMBER; ?>?text=Hola%20Paulo%2C%20quiero%20revisar%20un%20presupuesto%20estimado" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 border border-gray-300 hover:border-brand-500 text-gray-700 font-medium px-6 py-3 rounded-sm transition-all tracking-wide text-sm uppercase" data-track-event="whatsapp_click">
