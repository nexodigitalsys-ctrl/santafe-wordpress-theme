<?php
/**
 * Página dedicada: Reformas integrales
 */
...
$service_slug = 'reformas-integrales';
$service_name = $lang === 'ca' ? 'Reformes integrals' : 'Reformas integrales';
$service_desc = $lang === 'ca'
    ? 'Transformem espais amb pla d\'obra clar i acabats d\'alta qualitat.'
    : 'Transformamos espacios con plan de obra claro y acabados de alta calidad.';

$page_data = [
    'lang' => $lang,
    'title' => $lang === 'ca' ? 'Reformes integrals a Barcelona, Girona i Tarragona | Santa Fe' : 'Reformas integrales en Barcelona, Girona y Tarragona | Santa Fe',
    'description' => $service_desc,
    'canonical' => COMPANY_DOMAIN . '/' . $lang . '/reformas-integrales/',
    'schemas' => [
        ...
        function() use ($lang, $service_name) {
            return get_schema_breadcrumb([
                ...
                ['name' => $service_name, 'url' => '/' . $lang . '/reformas-integrales/'],
            ]);
        },
    ],
];
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid lg:grid-cols-2 gap-12 mb-16">
            <div class="space-y-6">
                ...
                <ul class="space-y-4">
                    <?php foreach (($lang === 'ca' ? [
                        ...
                        'Acabados de pavimento y revestimiento',
            ...
            <div class="aspect-video bg-slate-900 rounded-sm overflow-hidden">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/servicios/reformas/reforma-recepcion-acabada.webp'); ?>"
