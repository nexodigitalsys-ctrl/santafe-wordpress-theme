...
<section class="pt-40 pb-24 min-h-[70vh] bg-white">
    <div class="max-w-4xl mx-auto px-6 text-center">
        ...
        <a href="/<?php echo $lang; ?>/" class="inline-flex items-center bg-brand-600 hover:bg-brand-500 text-white font-medium px-5 py-2.5 rounded-xl transition-all tracking-wide text-xs uppercase">Volver al inicio</a>
    </div>
</section>
