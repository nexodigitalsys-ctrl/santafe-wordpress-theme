...
<section class="pt-40 pb-24 bg-white">
    <div class="max-w-3xl mx-auto px-6">
        <div class="mb-12">
            ...
            <h1 class="font-display font-bold text-4xl md:text-5xl text-gray-900 tracking-tight"><?php echo htmlspecialchars($titles[$type][$lang], ENT_QUOTES, 'UTF-8'); ?></h1>
        </div>

        <div class="space-y-10 text-gray-600 leading-relaxed">
            <?php if ($type === 'legal'): ?>
            <div class="bg-gray-50 border border-gray-200 rounded-sm p-8">
                <h2 class="font-display font-bold text-xl text-gray-900 mb-4"><?php echo $lang === 'ca' ? 'Dades del titular' : 'Datos del titular'; ?></h2>
                <p class="space-y-1 text-sm">
                    <strong class="text-gray-900"><?php echo $lang === 'ca' ? 'Titular' : 'Titular'; ?>:</strong> Construcciones Santa Fe Siglo XXI SLU<br>
                    <strong class="text-gray-900">NIF/CIF:</strong> [Insertar CIF]<br>
                    <strong class="text-gray-900"><?php echo $lang === 'ca' ? 'Domicili' : 'Domicilio'; ?>:</strong> [Insertar dirección]<br>
                    <strong class="text-gray-900">Email:</strong> <?php echo COMPANY_EMAIL; ?><br>
                    <strong class="text-gray-900"><?php echo $lang === 'ca' ? 'Telèfon' : 'Teléfono'; ?>:</strong> <?php echo COMPANY_PHONE_DISPLAY; ?><br>
                    <strong class="text-gray-900"><?php echo $lang === 'ca' ? 'Responsable privacitat' : 'Responsable privacidad'; ?>:</strong> Paulo
                </p>
            </div>
            <div>
                <h2 class="font-display font-bold text-xl text-gray-900 mb-4"><?php echo $lang === 'ca' ? 'Condicions d\'ús' : 'Condiciones de uso'; ?></h2>
            ...
            <div>
                <h2 class="font-display font-bold text-xl text-gray-900 mb-4"><?php echo $lang === 'ca' ? 'Propietat intel·lectual' : 'Propiedad intelectual'; ?></h2>
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-sm p-8">
                <h2 class="font-display font-bold text-xl text-gray-900 mb-4"><?php echo $lang === 'ca' ? 'Responsable del tractament' : 'Responsable del tratamiento'; ?></h2>
                <p class="text-sm">Paulo / Construcciones Santa Fe Siglo XXI SLU<br>Email: <?php echo COMPANY_EMAIL; ?></p>
            </div>
            <div>
                <h2 class="font-display font-bold text-xl text-gray-900 mb-4"><?php echo $lang === 'ca' ? 'Dades que recollim' : 'Datos que recogemos'; ?></h2>
            ...
            <div>
                <h2 class="font-display font-bold text-xl text-gray-900 mb-4"><?php echo $lang === 'ca' ? 'Els teus drets' : 'Tus derechos'; ?></h2>
            ...
            <div>
                <h2 class="font-display font-bold text-xl text-gray-900 mb-4"><?php echo $lang === 'ca' ? 'Mesures de seguretat' : 'Medidas de seguridad'; ?></h2>
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-sm p-8">
                <h2 class="font-display font-bold text-xl text-gray-900 mb-4"><?php echo $lang === 'ca' ? 'Què són les cookies?' : '¿Qué son las cookies?'; ?></h2>
            ...
            <div>
                <h2 class="font-display font-bold text-xl text-gray-900 mb-4"><?php echo $lang === 'ca' ? 'Tipus que utilitzem' : 'Tipos que utilizamos'; ?></h2>
                <ul class="space-y-3 text-sm">
                    <li><strong class="text-gray-900"><?php echo $lang === 'ca' ? 'Estrictament necessàries' : 'Estrictamente necesarias'; ?>:</strong> <?php echo $lang === 'ca' ? 'Sessió, seguretat i idioma.' : 'Sesión, seguridad e idioma.'; ?></li>
                    <li><strong class="text-gray-900"><?php echo $lang === 'ca' ? 'Analítiques' : 'Analíticas'; ?>:</strong> <?php echo $lang === 'ca' ? 'Google Analytics 4 (només amb consentiment).' : 'Google Analytics 4 (solo con consentimiento).'; ?></li>
                    <li><strong class="text-gray-900"><?php echo $lang === 'ca' ? 'Funcionals' : 'Funcionales'; ?>:</strong> <?php echo $lang === 'ca' ? 'WhatsApp i mapes embebuts.' : 'WhatsApp y mapas embebidos.'; ?></li>
                </ul>
            </div>
            <div>
                <h2 class="font-display font-bold text-xl text-gray-900 mb-4"><?php echo $lang === 'ca' ? 'Com gestionar-les?' : '¿Cómo gestionarlas?'; ?></h2>
