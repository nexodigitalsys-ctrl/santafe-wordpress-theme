...
<!-- Hero -->
<section class="relative py-20 md:py-28 bg-slate-950 border-b border-slate-800">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10 text-center">
        ...
        <p class="text-slate-300 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed"><?php echo $t['hero_subtitle']; ?></p>
        <a href="/<?php echo $lang; ?>/contacto/" class="inline-flex items-center gap-2 bg-brand-600 hover:bg-brand-500 text-slate-950 font-semibold px-8 py-4 rounded-sm transition-all tracking-wide text-sm uppercase">
            <?php echo $t['hero_cta']; ?>
...
<!-- Cobertura legal -->
<section class="py-24 md:py-32 bg-slate-900 border-b border-slate-800" data-reveal>
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-16">
            <h2 class="font-display font-bold text-3xl md:text-4xl text-white tracking-tight mb-4"><?php echo $t['section_legal']; ?></h2>
            <p class="text-slate-400 text-lg max-w-2xl mx-auto"><?php echo $t['section_legal_desc']; ?></p>
        </div>

        <div class="max-w-3xl mx-auto bg-slate-950 border border-slate-800 rounded-sm p-8 md:p-12">
            <h3 class="text-white font-semibold mb-6 text-lg"><?php echo $t['contract_intro']; ?></h3>
...
<section class="py-24 md:py-32 bg-slate-950 border-b border-slate-800" data-reveal>
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-16">
            <h2 class="font-display font-bold text-3xl md:text-4xl text-white tracking-tight mb-4"><?php echo $t['section_garantias']; ?></h2>
            <p class="text-slate-400 text-lg max-w-2xl mx-auto"><?php echo $t['section_garantias_desc']; ?></p>
        </div>

        <div class="grid md:grid-cols-2 gap-6">
            <?php foreach ($garantias_detalle as $g): ?>
            <div class="bg-slate-900 border border-slate-800 p-8 rounded-sm flex gap-5">
                ...
                <div>
                    <h3 class="font-display font-bold text-lg text-white mb-2"><?php echo $g['title']; ?></h3>
                    <p class="text-slate-400 text-sm leading-relaxed"><?php echo $g['desc']; ?></p>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
...
<section class="py-24 md:py-32 bg-slate-900 border-b border-slate-800" data-reveal>
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-16">
            <h2 class="font-display font-bold text-3xl md:text-4xl text-white tracking-tight mb-4"><?php echo $t['section_insurance']; ?></h2>
            <p class="text-slate-400 text-lg max-w-2xl mx-auto"><?php echo $t['section_insurance_desc']; ?></p>
        </div>

        <div class="grid md:grid-cols-3 gap-6">
            <?php foreach ($seguros as $s): ?>
            <div class="bg-slate-950 border border-slate-800 p-8 rounded-sm text-center">
                ...
                <h3 class="font-display font-bold text-xl text-white mb-3"><?php echo $s['name']; ?></h3>
                <p class="text-slate-400 text-sm"><?php echo $s['desc']; ?></p>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
...
<section class="py-24 md:py-32 bg-slate-950" data-reveal>
    <div class="max-w-4xl mx-auto px-6 text-center">
        <h2 class="font-display font-bold text-3xl md:text-5xl text-white tracking-tight mb-6"><?php echo $t['final_cta']; ?></h2>
        <p class="text-slate-400 text-lg mb-10"><?php echo $t['final_cta_sub']; ?></p>
        <a href="/<?php echo $lang; ?>/contacto/" class="inline-flex items-center gap-2 bg-brand-600 hover:bg-brand-500 text-slate-950 font-semibold px-10 py-5 rounded-sm transition-all tracking-wide text-base uppercase shadow-lg">
            <?php echo $t['hero_cta']; ?>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
        </a>
    </div>
