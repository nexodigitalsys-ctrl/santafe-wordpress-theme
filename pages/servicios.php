        ...
        <div class="max-w-4xl">
            ...
            <div class="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
                <a href="https://wa.me/<?php echo WHATSAPP_NUMBER; ?>?text=Hola%20Paulo%2C%20estoy%20interesado%20en%20un%20proyecto"
                   ...
                   class="inline-flex items-center justify-center gap-2 bg-[#25d366] hover:bg-[#128c7e] text-white font-semibold px-6 sm:px-10 py-3.5 sm:py-5 rounded-xl transition-all duration-300 text-sm sm:text-base uppercase tracking-wide shadow-lg whitespace-nowrap">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" class="flex-shrink-0"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c 0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                    <span class="hidden sm:inline"><?php echo $t['hero_cta_whatsapp']; ?></span>
                    <span class="sm:hidden">WhatsApp — 2h</span>
                </a>
                <a href="/<?php echo $lang; ?>/contacto/"
                   class="inline-flex items-center justify-center gap-2 bg-brand-600 hover:bg-brand-700 text-white font-semibold px-6 sm:px-10 py-3.5 sm:py-5 rounded-xl transition-all duration-300 text-sm sm:text-base uppercase tracking-wide shadow-lg whitespace-nowrap">
                    <?php echo $t['hero_cta_budget']; ?>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" class="flex-shrink-0"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                </a>
                <a href="tel:<?php echo COMPANY_PHONE; ?>"
                   class="inline-flex items-center justify-center gap-2 border border-warm-300 hover:border-warm-400 text-warm-600 hover:text-warm-900 font-medium px-6 sm:px-10 py-3.5 sm:py-5 rounded-xl transition-all duration-300 text-sm sm:text-base uppercase tracking-wide whitespace-nowrap">
...
<section class="py-24 md:py-32 bg-warm-50 border-y border-warm-200" data-reveal>
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <article class="group relative overflow-hidden rounded-sm bg-white border border-warm-200 card-lift flex flex-col">
                <div class="aspect-[16/9] overflow-hidden bg-warm-100 relative">
                ...
                <div class="p-6 flex-1 flex flex-col">
                    <h3 class="font-display font-bold text-xl text-warm-900 mb-2"><?php echo $svc['title']; ?></h3>
                    <p class="text-warm-500 text-sm mb-4 flex-1"><?php echo $svc['desc']; ?></p>
                    <div class="flex flex-wrap gap-2 mb-4">
                        <?php foreach ($svc['features'] as $feat): ?>
                        <span class="text-xs bg-warm-100 text-warm-600 px-2 py-1 rounded-sm"><?php echo $feat; ?></span>
                        <?php endforeach; ?>
                    </div>
                    <a href="/<?php echo $lang; ?>/<?php echo $slugs[$svc['slug']]; ?>/"
                       class="inline-flex items-center gap-2 bg-brand-600/10 hover:bg-brand-600/20 text-brand-500 text-sm font-semibold px-5 py-2.5 rounded-sm transition-all group/link mt-auto w-full justify-center">
...
<section class="py-24 md:py-32 bg-white" data-reveal>
    <div class="max-w-5xl mx-auto px-6">
        ...
        <div class="bg-warm-50 border border-warm-200 rounded-sm overflow-hidden">
            <div class="grid grid-cols-3 gap-0 text-sm font-semibold uppercase tracking-wider text-warm-500 border-b border-warm-200">
            ...
            <div class="grid grid-cols-3 gap-0 text-sm border-b border-warm-200/50 hover:bg-warm-100/30 transition-colors">
                <div class="p-4 md:p-6 text-warm-600"><?php echo $row['need']; ?></div>
                <div class="p-4 md:p-6 text-warm-900"><?php echo $row['service']; ?></div>
                <div class="p-4 md:p-6 text-brand-500 font-display font-bold text-right"><?php echo $row['price']; ?></div>
            </div>
            <?php endforeach; ?>
        </div>
        <p class="text-center text-warm-500 text-sm mt-6">
...
<section class="py-24 md:py-32 bg-white" data-reveal>
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-warm-50/50 border border-warm-200 rounded-sm p-6">
                ...
                <h3 class="font-display font-bold text-lg text-warm-900 mb-2"><?php echo $diff['title']; ?></h3>
                <p class="text-warm-500 text-sm leading-relaxed"><?php echo $diff['desc']; ?></p>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
...
<!-- ═══════════════════════════════════════════════════════════════
     6. FAQ + Schema
     ═══════════════════════════════════════════════════════════════ -->
<section class="py-24 md:py-32 bg-warm-50 border-y border-warm-200" id="faq-servicios" data-reveal>
