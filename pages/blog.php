...
<section class="py-24 md:py-32 bg-slate-900 border-y border-slate-800">
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <article class="bg-slate-950 border border-slate-800 rounded-sm p-6 card-lift group">
                <span class="text-brand-400 text-xs font-semibold uppercase tracking-[0.25em]"><?php echo $post['tag']; ?></span>
                <h2 class="font-display font-bold text-xl text-white mt-4 mb-3 group-hover:text-brand-400 transition-colors">
                    <a href="/<?php echo $lang; ?>/blog/<?php echo $post['slug']; ?>/" class="focus:outline-none">
                        <?php echo $post['title']; ?>
                    </a>
                </h2>
                <p class="text-slate-400 text-sm leading-relaxed mb-4"><?php echo $post['desc']; ?></p>
