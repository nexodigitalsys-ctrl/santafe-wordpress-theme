...
<section class="pt-40 pb-16 bg-white">
    <div class="max-w-7xl mx-auto px-6">
        <nav class="text-gray-500 text-sm mb-8" aria-label="Breadcrumb">
            <ol class="flex gap-2">
                ...
                <li>
                    ...
                    <?php else: ?>
                    <span aria-current="page" class="text-gray-600"><?php echo htmlspecialchars($item['name'], ENT_QUOTES, 'UTF-8'); ?></span>
                    <?php endif; ?>
                </li>
                <?php endforeach; ?>
            </ol>
        ...
        <h1 class="font-display font-bold text-4xl md:text-5xl lg:text-6xl text-gray-900 tracking-tight mb-6"><?php echo htmlspecialchars($data['h1'], ENT_QUOTES, 'UTF-8'); ?></h1>
        <p class="text-gray-500 text-lg max-w-2xl"><?php echo htmlspecialchars($data['description'], ENT_QUOTES, 'UTF-8'); ?></p>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid lg:grid-cols-[0.75fr_1.25fr] gap-10 items-start">
            <div>
                ...
                <h2 class="font-display font-bold text-3xl md:text-4xl text-gray-900 tracking-tight">Referencia antes de pedir presupuesto</h2>
            </div>
            <div class="bg-gray-50 border border-gray-200 rounded-sm p-8">
                <p class="text-gray-600 text-lg leading-relaxed"><?php echo htmlspecialchars($data['prices'], ENT_QUOTES, 'UTF-8'); ?></p>
                <p class="text-gray-500 text-sm mt-4">La cifra final depende de visita técnica, mediciones, estado actual, calidades, licencias y calendario.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="max-w-4xl mx-auto space-y-16">
            <div>
                ...
                <h2 class="font-display font-bold text-2xl md:text-3xl text-gray-900 mb-4"><?php echo $lang === 'ca' ? 'El que molts no et diuen' : 'Lo que muchos no te dicen'; ?></h2>
                <p class="text-gray-600 text-lg leading-relaxed"><?php echo $data['problem']; ?></p>
            </div>
            <div class="bg-white border border-gray-200 rounded-sm p-8 md:p-10">
                <div class="flex items-center gap-4 mb-4">
                    <div class="industrial-line w-12"></div>
                ...
                <p class="text-gray-500 leading-relaxed"><?php echo $data['agitate']; ?></p>
            </div>
            <div>
                <div class="flex items-center gap-4 mb-4">
                    <div class="industrial-line w-12"></div>
                ...
                <h2 class="font-display font-bold text-2xl md:text-3xl text-gray-900 mb-4"><?php echo $lang === 'ca' ? 'Com ho fem a Santa Fe' : 'Cómo lo hacemos en Santa Fe'; ?></h2>
                <p class="text-gray-600 text-lg leading-relaxed"><?php echo $data['solution']; ?></p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-24 bg-white">
    <div class="max-w-4xl mx-auto px-6">
        <h2 class="font-display font-bold text-3xl md:text-4xl text-gray-900 tracking-tight mb-10">Preguntas frecuentes</h2>
        <div class="space-y-4">
            <?php foreach ($data['faq'] as $item): ?>
            <details class="bg-gray-50 border border-gray-200 rounded-sm p-6">
                <summary class="cursor-pointer font-semibold text-gray-900"><?php echo htmlspecialchars($item['q'], ENT_QUOTES, 'UTF-8'); ?></summary>
                <p class="text-gray-500 mt-4 leading-relaxed"><?php echo htmlspecialchars($item['a'], ENT_QUOTES, 'UTF-8'); ?></p>
            </details>
            <?php endforeach; ?>
        </div>
    </div>
...
<section class="py-24 bg-white border-y border-gray-200">
    <div class="max-w-7xl mx-auto px-6">
        <h2 class="font-display font-bold text-3xl md:text-4xl text-gray-900 tracking-tight mb-12">
            <?php echo $lang === 'ca' ? 'Què inclou el nostre servei?' : '¿Qué incluye nuestro servicio?'; ?>
        </h2>
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            <?php foreach ($data['features'] as $feature): ?>
            <div class="flex items-start gap-4 bg-gray-50 border border-gray-200 rounded-sm p-6">
                ...
                <span class="text-gray-700 text-sm"><?php echo htmlspecialchars($feature, ENT_QUOTES, 'UTF-8'); ?></span>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="relative">
                ...
                <div class="relative bg-white border border-gray-200 rounded-sm p-6 pt-10">
                    <h3 class="font-display font-bold text-lg text-gray-900 mb-2"><?php echo htmlspecialchars($phase['title'], ENT_QUOTES, 'UTF-8'); ?></h3>
                    <p class="text-gray-500 text-sm leading-relaxed"><?php echo htmlspecialchars($phase['desc'], ENT_QUOTES, 'UTF-8'); ?></p>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
...
<section class="py-24 bg-white relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10 text-center">
        <h2 class="font-display font-bold text-4xl md:text-5xl text-gray-900 tracking-tight mb-6">
        ...
        <div class="flex flex-wrap gap-4 justify-center">
            <a href="/<?php echo $lang; ?>/contacto/" class="inline-flex items-center gap-2 bg-brand-600 hover:bg-brand-500 text-gray-900 font-semibold px-8 py-4 rounded-sm transition-all tracking-wide text-sm uppercase">
                <?php echo htmlspecialchars($data['cta_primary'], ENT_QUOTES, 'UTF-8'); ?>
            </a>
            <a href="tel:+34665737547" class="inline-flex items-center gap-2 border border-gray-300 hover:border-gray-400 text-gray-700 font-medium px-8 py-4 rounded-sm transition-all tracking-wide text-sm uppercase">
