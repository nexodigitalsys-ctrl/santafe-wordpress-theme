...
$service_name = $lang === 'ca' ? 'Obra nova' : 'Obra nueva';
$service_desc = $lang === 'ca'
    ? 'Construcció de cases, locals i edificis des de zero. Llicències incloses. Clau en mà.'
    : 'Construcción de casas, locales y edificios desde cero. Licencias incluidas. Llave en mano.';

$page_data = [
    'lang' => $lang,
    'title' => $lang === 'ca' ? 'Obra nova a Barcelona, Girona i Tarragona | Santa Fe' : 'Obra nueva en Barcelona, Girona y Tarragona | Santa Fe',
    'description' => $service_desc,
    'canonical' => COMPANY_DOMAIN . '/' . $lang . '/obra-nueva/',
    'schemas' => [
        ...
        function() use ($lang, $service_name) {
            return get_schema_breadcrumb([
                ...
                ['name' => $service_name, 'url' => '/' . $lang . '/obra-nueva/'],
            ]);
        },
    ],
];
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid lg:grid-cols-2 gap-12 mb-16">
            <div class="space-y-6">
                ...
                <ul class="space-y-4">
                    <?php foreach (($lang === 'ca' ? [
                        'Visita tècnica i mesurament',
                        'Pressupost tancat per fases',
                        'Gestió de llicències d\'obra',
                        'Coordinació de gremis',
                        'Seguiment fotogràfic setmanal',
                        'Lliurament amb clau en mà',
                    ] : [
                        'Visita técnica y mediciones',
