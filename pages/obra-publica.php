...
$service_slug = 'obra-publica';
$service_name = $lang === 'ca' ? 'Obra pública' : 'Obra pública';
$service_desc = $lang === 'ca'
    ? 'Infraestructures i urbanització amb certificació i compliment normatiu.'
    : 'Infraestructuras y urbanización con certificación y cumplimiento normativo.';

$page_data = [
    'lang' => $lang,
    'title' => $lang === 'ca' ? 'Obra pública a Barcelona, Girona i Tarragona | Santa Fe' : 'Obra pública en Barcelona, Girona y Tarragona | Santa Fe',
    'description' => $service_desc,
    'canonical' => COMPANY_DOMAIN . '/' . $lang . '/obra-publica/',
    'schemas' => [
        ...
        function() use ($lang, $service_name) {
            return get_schema_breadcrumb([
                ...
                ['name' => $service_name, 'url' => '/' . $lang . '/obra-publica/'],
            ]);
        },
    ],
];
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid lg:grid-cols-2 gap-12 mb-16">
            <div class="space-y-6">
                ...
                <ul class="space-y-4">
                    <?php foreach (($lang === 'ca' ? [
                        'Urbanització de vies i espais públics',
                        'Infraestructures de drenatge',
                        'Pavimentació i senyalització',
                        'Obres per a administracions',
                        'Certificació de qualitat',
                        'Documentació i traçabilitat',
                    ] : [
                        'Urbanización de vías y espacios públicos',
                        'Infraestructuras de drenaje',
                        'Pavimentación y señalización',
                        'Obras para administraciones',
            ...
            <div class="aspect-video bg-slate-900 rounded-sm overflow-hidden">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/servicios/obra-publica/obra-publica-calzada-acabada.webp'); ?>"
