    ...
    'schemas' => [
        ...
        function() use ($isCa) {
            return json_encode([
                ...
                'url' => COMPANY_DOMAIN,
                'logo' => COMPANY_DOMAIN . '/assets/img/construcciones-santa-fe-girona.png',
                'founder' => [
                    '@type' => 'Person',
                    'name' => 'Paulo',
...
<section class="pt-32 pb-20 md:pb-28 bg-white relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        <div class="max-w-4xl mb-16">
            ...
            <p class="text-warm-600 text-lg md:text-xl leading-relaxed max-w-2xl mb-10">
                <?php echo $t['hero_p']; ?>
            </p>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
                ...
                <div class="space-y-5 text-warm-600 leading-relaxed text-lg">
                    <p><?php echo $t['who_p1']; ?></p>
                    <p><?php echo $t['who_p2']; ?></p>
                    <div class="bg-brand-600/10 border-l-4 border-brand-600 p-6 rounded-r-sm">
                        <p class="text-warm-900 font-semibold italic"><?php echo $t['who_p3']; ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-24 md:py-32 bg-white" data-reveal>
    <div class="max-w-5xl mx-auto px-6">
        ...
        <div class="relative">
            <!-- Linha vertical -->
            <div class="absolute left-4 md:left-1/2 top-0 bottom-0 w-px bg-warm-100 md:-translate-x-px"></div>
            ...
            <div class="relative mb-12 last:mb-0">
                ...
                <div class="pl-10 md:hidden">
                    ...
                    <h3 class="font-display font-bold text-lg text-warm-900 mb-1"><?php echo $event['title']; ?></h3>
                    <p class="text-warm-500 text-sm leading-relaxed"><?php echo $event['desc']; ?></p>
                </div>
                ...
                <div class="hidden md:flex items-start">
                    ...
                    <div class="w-1/2 pr-12 text-right">
                        ...
                        <h3 class="font-display font-bold text-xl text-warm-900 mb-2"><?php echo $event['title']; ?></h3>
                        <p class="text-warm-500 text-sm leading-relaxed"><?php echo $event['desc']; ?></p>
                    </div>
        ...
        <div class="flex flex-wrap gap-4 justify-center">
            <a href="/<?php echo $lang; ?>/contacto/"
               class="inline-flex items-center gap-2 bg-brand-600 hover:bg-brand-500 text-white font-medium px-5 py-2.5 rounded-xl transition-all tracking-wide text-xs uppercase">
                <?php echo $isCa ? 'Sol·licitar visita tècnica' : 'Solicitar visita técnica'; ?>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
            </a>
            <a href="https://wa.me/<?php echo WHATSAPP_NUMBER; ?>?text=Hola%20Paulo%2C%20quiero%20información"
